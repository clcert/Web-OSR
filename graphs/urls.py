...
urlpatterns = [
    ...
    url(r'^https/key-bits/(?P<port>[0-9]+)$', views.certificate_key_bits, name='graphs/https/key-bits'),
    url(r'^https/key-bits/(?P<port>[0-9]+)/(?P<scan_date>\d+-\d+-\d+)$', views.certificate_key_bits, name='graphs/https/key-bits'),
